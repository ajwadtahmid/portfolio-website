  ...
  return (
    <nav className='navbar'>
        ...
        <div className="desktopMenu">
          ...
          <Link activeClass="active" to="contact" spy={true} smooth={true} offset={-150} duration={500} className="desktopMenuListItems">Contact</Link>
        </div>
        ...
        <div className="mobileMenu" style={{display:showMenu? "flex":"none"}}>
          ...
          <Link activeClass="active" to="contact" spy={true} smooth={true} offset={-150} duration={500} className="mobileMenuListItems" onClick={()=>setShowMenu(false)}>Contact</Link>
        </div>
    </nav>
  )
}
